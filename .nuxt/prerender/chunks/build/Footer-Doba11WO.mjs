...
import { defineComponent, mergeProps, withCtx, createVNode, createTextVNode, unref, useSSRContext } from 'file://C:/Users/Alfonso.Nakale/Downloads/Dev%20Projects/alfonso-portfolio/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file://C:/Users/Alfonso.Nakale/Downloads/Dev%20Projects/alfonso-portfolio/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-slate-400"${_scopeId}>Cell \xB7 </span>+264 81 468 7647 `);
          } else {
            return [
              createVNode("span", { class: "text-slate-400" }, "Cell \xB7 "),
...
export { _sfc_main as _, getProjectBySlug as g, projects as p };
//# sourceMappingURL=Footer-Doba11WO.mjs.map
