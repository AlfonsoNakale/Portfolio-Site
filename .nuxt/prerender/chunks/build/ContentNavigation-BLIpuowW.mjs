import { defineComponent, useSlots, h, toRefs, computed, toRef, isRef, useSSRContext } from 'file://C:/Users/Alfonso.Nakale/Downloads/Dev%20Projects/alfonso-portfolio/node_modules/vue/index.mjs';
...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-D_xpVYMB.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-wVd181Ma.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BLIpuowW.mjs.map
