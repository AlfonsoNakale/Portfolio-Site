import { defineComponent, ref, mergeProps, unref, useSSRContext, withCtx, createTextVNode, computed, resolveDirective, withDirectives, createBlock, openBlock, createVNode, toDisplayString } from "C:/Users/Alfonso.Nakale/Downloads/Dev Projects/alfonso-portfolio/node_modules/vue/index.mjs";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrGetDirectiveProps } from "vue/server-renderer";
import { Icon } from "@iconify/vue";
import { _ as _export_sfc } from "../server.mjs";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-Dkcz6mcN.js";
import { p as projects, _ as _sfc_main$5 } from "./Footer-Doba11WO.js";
import "ofetch";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`→ View Full Résumé`);
          } else {
            return [
              createTextVNode("→ View Full Résumé")
            ];
          }
        }),
        _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    id: "experience",
    class: "scroll-mt-16 sm:scroll-mt-20 md:scroll-mt-24"
  }, _attrs))}><h3 class="text-xs sm:text-sm font-semibold uppercase tracking-widest text-emerald-400">Experience</h3><ul class="mt-3 sm:mt-4 space-y-4 sm:space-y-6"><li class="text-slate-300"><div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-0"><p class="font-medium text-sm sm:text-base text-slate-100 leading-snug">Web Developer · Ohlthaver &amp; List Group</p><span class="text-xs font-semibold text-slate-400 flex-shrink-0">2024 — Present</span></div><p class="mt-1 text-xs sm:text-sm text-slate-400 leading-relaxed">Map, Develop, Debug solutions that inform stategies and meet user needs. such as WordPress and Webflow</p></li><li class="text-slate-300"><div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-0"><p class="font-medium text-sm sm:text-base text-slate-100 leading-snug">Curriculum Advisory Board Member · NUST</p><span class="text-xs font-semibold text-slate-400 flex-shrink-0">2025 — 2029</span></div><p class="mt-1 text-xs sm:text-sm text-slate-400 leading-relaxed">Supporting the development of Namibia&#39;s professionals in the field of Advanced Web Technologies and Big Data Technologies.</p></li><li class="text-slate-300"><div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-0"><p class="font-medium text-sm sm:text-base text-slate-100 leading-snug">Digital &amp; Dev Specialist · Ohlthaver &amp; List Group</p><span class="text-xs font-semibold text-slate-400 flex-shrink-0">2022 — 2024</span></div><p class="mt-1 text-xs sm:text-sm text-slate-400 leading-relaxed">Front-end web development, maintenance, and updating of web presences.</p></li><li class="text-slate-300"><div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-0"><p class="font-medium text-sm sm:text-base text-slate-100 leading-snug">Digital Change - Projects · Standard Bank</p><span class="text-xs font-semibold text-slate-400 flex-shrink-0">2020 — 2021</span></div><p class="mt-1 text-xs sm:text-sm text-slate-400 leading-relaxed">Identify change needs and scope, including coordinating change management activities.</p></li></ul></section>`);
}
            ...
            if (_push2) {
              ...
              return [
                withDirectives((openBlock(), createBlock("article", { class: "mouse-glow rounded-md border border-slate-800 bg-slate-900/40 p-3 sm:p-4 transition hover:border-slate-700" }, [
                  ...
                  createVNode("div", { class: "mt-2 text-xs text-slate-500 leading-relaxed" }, toDisplayString(project.tech.join(" · ")), 1)
                ])), [
                  [_directive_glow]
                ])
              ];
...
const _imports_0 = "" + __buildAssetsURL("bio-image_2.SqKRxEpY.jpg");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-xl sm:text-2xl text-emerald-400" data-v-d5adf747${_scopeId}>·</span> About`);
          } else {
            return [
              createVNode("span", { class: "text-xl sm:text-2xl text-emerald-400" }, "·"),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-xl sm:text-2xl text-emerald-400" data-v-d5adf747${_scopeId}>·</span> Experience`);
          } else {
            return [
              createVNode("span", { class: "text-xl sm:text-2xl text-emerald-400" }, "·"),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-xl sm:text-2xl text-emerald-400" data-v-d5adf747${_scopeId}>·</span> Projects`);
          } else {
            return [
              createVNode("span", { class: "text-xl sm:text-2xl text-emerald-400" }, "·"),
...
//# sourceMappingURL=index-BszpNLiR.js.map
